...
class Harmonics {
    ...
    constructor(node) {
        ...
        // The main oscilloscope canvas.
        this.foreground = doc.createElement("canvas");
        this.foreground.setAttribute("width", width);
        this.foreground.setAttribute("height", height);
    ...
    renderBackground() {
        ...
        ctx.font = fontWithSize(style, Math.round(labelHeight * 0.5) + "px");
