...
export class Color {
   ...
   */
  toCss() {
    const rgb = this._red + ', ' + this._green + ', ' + this._blue;
   ...
   * a new instance representing the combination.
   */
  mix(other, weight) {
    ...
    const p = weight;
    const w = (2 * p) - 1;
    const a = this._alpha - other._alpha;
    ...
    if ((match = cssString.match(/^#([a-fA-F0-9]{3,8})$/))) {
      ...
      switch (match[0]) {
        case 'rgb': {
          ...
          const r = Color._parseNum(match[1], 255, true);
          const g = Color._parseNum(match[2], 255, true);
          const b = Color._parseNum(match[3], 255, true);
          if (isNaN(r + g + b)) {
            return undefined;
          }
        ...
        case 'rgba': {
          ...
          const g = Color._parseNum(match[2], 255, true);
          const b = Color._parseNum(match[3], 255, true);
          const a = Color._parseNum(match[4], 1);
          if (isNaN(r + g + b + a)) {
            return undefined;
          }
